...
if(isset($_POST['add-btn']))
{
    ...
    if($password==$confirm_password)
    {
       ...
       {
           $user_query="INSERT INTO user (u_firstname, u_lastname, u_ffirstname, u_flastname, u_fnid, u_email, u_dob, u_gender, u_division, u_password, u_role) VALUES ('$fname','$lname','$ffname', '$flname', '$fnid','$email', '$dob', '$gender', '$division', '$password', '0' )";
