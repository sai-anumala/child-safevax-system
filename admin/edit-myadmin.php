                        ...
                        <div class="row gx-3 mb-3">
                            <div class="col-md-6">
                                ...
                                < <select name="division" class="custom-select" >
                                    ...
                                    <option value="Somajiguda" <?php if($row['u_division']=="Somajiguda"){echo "selected";}?>>Somajiguda</option>
                                    <option value="Kukatpally" <?php if($row['u_division']=="Kukatpally"){echo "selected";}?>>Kukatpally</option>
                                    <option value="Malkajgiri" <?php if($row['u_division']=="Malkajgiri"){echo "selected";}?>>Malkajgiri</option>
                                    <option value="Lakdikapul" <?php if($row['u_division']=="Lakdikapul"){echo "selected";}?>>Lakdikapul</option>
                                    <option value="Secunderabad" <?php if($row['u_division']=="Secunderabad"){echo "selected";}?>>Secunderabad</option>
                                    <option value="Kondapur" <?php if($row['u_division']=="Kondapur"){echo "selected";}?>>Kondapur</option>
                                    <option value="Madhapur" <?php if($row['u_division']=="Madhapur"){echo "selected";}?>>Madhapur</option>
                                    <option value="Moghalpura" <?php if($row['u_division']=="Moghalpura"){echo "selected";}?>>Moghalpura</option>
                                </select>
                            </div>
                            </div>
                          <div class="row gx-3 mb-3">
