...
//Define name spaces
	...
	if(isset($_POST['send'])){
        ...
        $up = date('Y-m-d', strtotime($push. ' + 10 days'));
                    ...
                    {  
						...
						//Email body
							$mail->Body = "<p>Dear $full_name ,<br>
                                            Your appointment for dose no $dose of $vname vaccine is confirmed. Your vaccination date is $up_push. You can get vaccinated from 9.00 am to 12.00 pm on this date. Get your dose on time near your vaccine center and stay protected.<br><br>
							              Regards<br>
